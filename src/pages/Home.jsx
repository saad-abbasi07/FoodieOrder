...
export default function Home() {
  return (
    <div>
      {/* Hero */}
      <section className="bg-orange-500 text-white py-24 relative">
      ...
      <section className="max-w-7xl mx-auto px-6 py-16">
        ...
        <div className="grid grid-cols-2 sm:grid-cols-5 gap-6">
          {categories.map((cat, i) => (
            <div key={i} className="bg-white rounded-xl shadow hover:shadow-lg transition p-4 text-center">
              <img src={cat.img} alt={cat.name} className="w-full h-28 object-cover rounded-lg mb-4" />
      ...
      <section className="bg-gray-100 py-16">
        <div className="max-w-7xl mx-auto px-6">
          <div className="flex items-center justify-between mb-8">
            ...
            <Link to="/restaurants" className="text-orange-600 hover:underline">See all</Link>
          </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-8">
            {restaurants.map((res) => (
              ...
              >
                <img src={res.img} alt={res.name} className="w-full h-48 object-cover rounded-t-xl" />
                <div className="p-4">
